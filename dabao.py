...
appFileFullPath = '/Users/apple/Library/Developer/Xcode/DerivedData/C_JDHOE-gttrnaqsnzjyrlgcmkmbwojwejlr/Build/Products/Debug-iphoneos/C_JDHOE.app'
...
if __name__ == '__main__':
    des = raw_input("请输入更新日志:")
    str ='fir publish /Users/apple/Desktop/ProgramBag/Payload.ipa -Q -c \'%s\''%(des)
    print str
    bulidIPA()
    uploadIPA('%s/Payload.ipa'%packBagPath)
    nowtime = os.popen('fir publish /Users/apple/Desktop/ProgramBag/Payload.ipa -Q -c \'%s\'' % (des))
    print nowtime.read()
    os.popen('open /Users/apple/Desktop/ProgramBag/fir-C_JDHOE.png')
    openDownloadUrl()
